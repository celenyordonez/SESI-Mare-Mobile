...
const maisBemAvaliadas = [
  { id: '1', image: 'https://i.scdn.co/image/ab67616d0000b2734121fa0c2243d6046e386ce2' }, // Exemplo: Thriller
  { id: '2', image: 'https://i.scdn.co/image/ab67616d0000b27313b3e37318a0c247b550bccd' }, // Exemplo: Ed Sheeran
  { id: '3', image: 'https://i.scdn.co/image/ab67616d0000b273dc30583ba717007b00cceb25' },
  { id: '4', image: 'https://picsum.photos/200/200?random=4' },
];
 
const talvezGoste = [
  { id: '1', image: 'https://i.scdn.co/image/ab67616d0000b2734718e2b124f79258be7bc452' }, // Exemplo: Starboy
  { id: '2', image: 'https://i.scdn.co/image/ab67616d0000b273934f5dbe368a5c363910cbe8' }, // Exemplo: Ariana Grande
  { id: '3', image: 'https://i.scdn.co/image/ab67616d0000b273d2a715f5fc81ef3520556e82' }, // Exemplo: Seu Jorge
  { id: '4', image: 'https://picsum.photos/200/200?random=5' },
];
...
export default function ExploreScreen() {
  // Função para simular ações de clique
  const handlePress = (acao: string) => {
    console.log(`Ação acionada: ${acao}`);
  };
...
<ImageBackground
              source={{ uri: 'https://picsum.photos/400/200?random=10' }} // Imagem de fundo estilo Synthwave
...
<Text style={styles.tagText}>SINTETIZADOR NEON</Text>
</View>
<TouchableOpacity 
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#10141D', // Cor de fundo principal
  },
  scrollView: {
    flex: 1,
  },
  ...
  badge: {
    ...
    top: 0,
    right: 0,
    backgroundColor: '#3B82F6', // Cor do indicador de notificação
    borderRadius: 10,
    width: 16,
    height: 16,
  ...
  heroOverlay: {
    flex: 1,
    backgroundColor: 'rgba(0,0,0,0.4)', // Camada para escurecer a imagem de fundo
    borderRadius: 16,
    padding: 15,
    justifyContent: 'space-between',
  },
  ...
  playButton: {
    backgroundColor: '#60A5FA', // Botão de reprodução
    width: 36,
    height: 36,
    borderRadius: 18,
    justifyContent: 'center',
